    ...
    useEffect(() => {
        const maxLikedComment = async () => {
            try {
                ...
                const result = await response.json();
                const maxLikedComment = result.maxLikedComment.comment_text;
                const maxLikedCommentCount = result.maxLikedComment.like_count;
                setMaxLikedCommentText(maxLikedComment);
                setMaxLikedCommentCount(maxLikedCommentCount);
                console.log(result);
                return result;
            } catch (error) {
                console.error('Error fetching data:', error.message);
